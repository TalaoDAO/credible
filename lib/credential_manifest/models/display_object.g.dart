...
DisplayObject _$DisplayObjectFromJson(Map<String, dynamic> json) =>
    DisplayObject(
      DisplayObject._displayMappingFromJson(json['title']),
      DisplayObject._displayMappingFromJson(json['subtitle']),
      DisplayObject._displayMappingFromJson(json['description']),
